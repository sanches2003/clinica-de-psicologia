...
<body>
    ...
    <form method="POST" action="/avaliacaopsicologica/{{$avaliacao->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data_avaliacao">Data</label>
            <input type="date" id="data_avaliacao" value="{{$avaliacao->data_avaliacao}}" name="data_avaliacao" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="observacoes" name="observacoes" class="form-control" rows="4" required>{{$avaliacao->observacoes}}</textarea>
        </div>
