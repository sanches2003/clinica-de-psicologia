...
<head>
    ...
    <title>Cadastro de Condição</title>
...
<body>
    ...
    <form method="POST" action="/problema" style="max-width: 600px; margin: 0 auto;">
        @csrf
        <div class="form-group">
            <label for="data_identificacao">Data</label>
            <input type="date" id="data_identificacao" name="data_identificacao" class="form-control" required>
        </div>
        <div class="form-group">
