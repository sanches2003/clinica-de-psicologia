...
<head>
    ...
    <title>Edição de Condição</title>
...
<body>
    ...
    <form method="POST" action="/problema/{{$problema->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data_identificacao">Data</label>
            <input type="date" id="data_identificacao" value="{{$problema->data_identificacao}}" name="data_identificacao" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="condicao" name="condicao" class="form-control" rows="4" required>{{$problema->condicao}}</textarea>
        </div>
        <div class="form-group">
            <label for="evolucao">Evolução</label>
            <textarea id="evolucao" name="evolucao" class="form-control" rows="4" required>{{$problema->evolucao}}</textarea>
        </div>
