...
<body>
    ...
    <form method="POST" action="/agendamento/{{$agendamento->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="date" id="data" value="{{$agendamento->data}}" name="data" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="hora">Hora</label>
            <input type="time" id="hora" value="{{$agendamento->hora}}" name="hora" class="form-control" required>
        </div>
