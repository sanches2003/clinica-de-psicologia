...
<head>
    ...
    <title>Edição de Encaminhamento</title>
...
<body>
    ...
    <form method="POST" action="/encaminhamento/{{$encaminhamento->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data">Data</label>
            <input type="date" id="data" value="{{$encaminhamento->data}}" name="data" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="nome_profissional" name="nome_profissional" class="form-control" rows="4" required>{{$encaminhamento->nome_profissional}}</textarea>
        </div>
        <div class="form-group">
            <label for="descricao">Descrição</label>
            <textarea id="descricao" name="descricao" class="form-control" rows="4" required>{{$encaminhamento->descricao}}</textarea>
        </div>
