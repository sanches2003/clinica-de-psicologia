...
<body>
    ...
    <form method="POST" action="/terapia/{{$terapia->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data">Data</label>
            <input type="date" id="data" value="{{$terapia->data}}" name="data" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="notas" name="notas" class="form-control" rows="4" required>{{$terapia->notas}}</textarea>
        </div>
        <div class="form-group">
            <label for="tecnica">Técnica</label>
            <textarea id="tecnica" name="tecnica" class="form-control" rows="4" required>{{$terapia->tecnica}}</textarea>
        </div>
