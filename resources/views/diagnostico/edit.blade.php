...
<head>
    ...
    <title>Edição de Diagnóstico</title>
...
<body>
    ...
    <form method="POST" action="/diagnostico/{{$diagnostico->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data">Data</label>
            <input type="date" id="data" value="{{$diagnostico->data}}" name="data" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="diagnostico" name="diagnostico" class="form-control" rows="4" required>{{$diagnostico->diagnostico}}</textarea>
        </div>
        <div class="form-group">
            <label for="descricao">Descrição</label>
            <textarea id="descricao" name="descricao" class="form-control" rows="4" required>{{$diagnostico->descricao}}</textarea>
        </div>
