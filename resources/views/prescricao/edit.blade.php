...
<head>
    ...
    <title>Edição de Prescrição</title>
...
<body>
    ...
    <form method="POST" action="/prescricao/{{$prescricao->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data">Data</label>
            <input type="date" id="data" value="{{$prescricao->data}}" name="data" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="descricao" name="descricao" class="form-control" rows="4" required>{{$prescricao->descricao}}</textarea>
        </div>
