...
<head>
    ...
    <title>Edição do Tratamento</title>
...
<body>
    ...
    <form method="POST" action="/tratamento/{{$tratamento->id}}" style="max-width: 600px; margin: 0 auto;">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="data_inicio">Data Início</label>
            <input type="date" id="data_inicio" value="{{$tratamento->data_inicio}}" name="data_inicio" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea id="objetivos" name="objetivos" class="form-control" rows="4" required>{{$tratamento->objetivos}}</textarea>
        </div>
        <div class="form-group">
            <label for="progresso">Progresso</label>
            <textarea id="progresso" name="progresso" class="form-control" rows="4" required>{{$tratamento->progresso}}</textarea>
        </div>
